...
public class CustomerController {
	...
	//----encoding the password into some hashing value-------------
...
//not working-		Customer customer=(Customer)auth.getPrincipal();//---------1st approch
		 Customer customer= customerService.getCustomerDetailsByEmail(auth.getName());//--------2nd approch
